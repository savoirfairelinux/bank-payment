...
class banking_export_international(orm.Model):
    """International export"""

    _name = 'banking.export.international'
    ...
    _columns = {
        'payment_order_ids': fields.many2many(
            'payment.order',
            'account_payment_order_international_rel',
            'banking_export_international_id', 'account_order_id',
            'Payment Orders',
            readonly=True),
